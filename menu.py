...
class Menu():
    ...
    def render(self, screen):
        ...
        self.nyatheme.title_font_size=50
        ...
        self.menu = pygame_menu.Menu('Nyance Nyance Revolution', self.state.WIDTH, self.state.HEIGHT,
                    theme=self.nyatheme, mouse_motion_selection=True)
        self.menu.add.label("> Beat Beat-up! <")
